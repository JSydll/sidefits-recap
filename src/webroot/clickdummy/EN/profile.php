		...
		<div id="profile">
			...
			<div class="content-block">
				...
				<div class="profile-misc">
					...
					<p>Hamburg<br /><i>Touch Rugby, Ultimate Frisbee, Volleyball, Running</i></p>
				</div>
				<br class="clear" />
				<div class="profile-body">
					<h3>Profile Information</h3>
					<p>Here comes the profile content like preferred time to work out, work out intensity, challenges participated or just participating in, general targets, quotes or idols in sport, ways to contact etc.</p><br />
					<h4>Comment</h4>
					<p>This draw implies that Lora shares all profile information with her matched Sidefits. Nevertheless, she can edit this in the account settings anytime.</p>
