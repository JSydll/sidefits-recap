                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://workoutcloud.net/images/email/cloudBenefits_DE.png" width="564" style="max-width:700px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1><span style='color:#4d4d4d'><?php echo $initiator; ?> empfiehlt Dir <?php echo $workout; ?>!</span></h1>
<br>
Versuche dich an dem Workout oder erstelle Dein eigenes! Bist Du bereit für die Herausforderung?
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Workout ansehen!" href="<?php echo $workoutLink; ?>" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Workout ansehen!</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #4CB0A9;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Workout erstellen" href="https://workoutcloud.net/view/index.php#/creator" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Workout erstellen</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
Sidefits<br>
Joschka Sondhof &amp; Philipp Mägel GbR<br>
Osterbrook 22<br>
20537 Hamburg<br>
<br>
Diese Email wurde automatisch mit Hilfe des Sidefits WorkoutCloud Services durch einen Nutzer erstellt. Solltest Du keine weiteren Emails dieser Art erhalten wollen, kontaktiere bitte <a href='mailto:<?php echo $initiatorMail; ?>'><?php echo $initiator; ?></a>.<br /><br />
                        </td>
                    </tr>
                </tbody></table>
