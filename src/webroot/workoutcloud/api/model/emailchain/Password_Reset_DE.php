...
//// - User ["m"]
//// - Reset token ["t"]
if(isset($_GET["s"])&&isset($_GET["n"])&&isset($_GET["m"])&&isset($_GET["t"])){
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://workoutcloud.net/images/email/lost_key.jpg" width="564" style="max-width:700px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="text-align: center;"><span style="color:#4d4d4d"><span style="font-size:14px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span class="s1">
                            Hey <?php echo $name; ?>. Wir haben eine Anfrage erhalten, dein Passwort zu ändern.&nbsp;&nbsp;Falls das nicht du warst, ignoriere diese Email. Um dein Passwort zu ändern, folge dem Link.</span></span></span></span></h1>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Passwort zurücksetzen" href="https://workoutcloud.net/view/#/resetPassword?m=<?php echo $email; ?>&t=<?php echo $token; ?>" target="_blank" style="font-weight: normal;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Klicke um Passwort zurückzusetzen</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px; line-height: 200%; text-align: left;">
                            ...
                            <em>Falls der Link nicht funktioniert, kopiere den Link https://workoutcloud.net/view/#/resetPassword?m=<?php echo $email; ?>&amp;t=<?php echo $token; ?> direkt in die Adresszeile deines Browsers. Falls du Fragen hast, wende dich an welcome@workoutcloud.net.<br />
                            <br />
                            Copyright © 2016 Sidefits, All rights reserved.</em><br />
                            <strong>Our mailing address is:</strong><br />
                            Sidefits<br />
                            Joschka Sondhof and Philipp Mägel GbR<br />
                            Osterbrook 22<br />
                            20537 Hamburg
                        </td>
                    </tr>
