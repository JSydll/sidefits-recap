                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://workoutcloud.net/images/email/lost_key_en.jpg" width="564" style="max-width:700px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="text-align: center;"><span style="color:#4d4d4d"><span style="font-size:14px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span class="s1">We have received a request to change your password. Please click the link below to reset your password.</span></span></span></span></h1>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Click to reset password" href="https://workoutcloud.net/view/#/resetPassword?m=<?php echo $email; ?>&t=<?php echo $token; ?>" target="_blank" style="font-weight: normal;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Click to reset password</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px; line-height: 200%; text-align: left;">
                            ...
                            <em>If redirection does not work, copy this link https://workoutcloud.net/view/#/resetPassword?m=<?php echo $email; ?>&amp;t=<?php echo $token; ?> directly into your browser. If you have any questions let us know at welcome@workoutcloud.net.<br>
<br>
