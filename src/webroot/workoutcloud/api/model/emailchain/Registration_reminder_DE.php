                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="366" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                            ...
                            Reminder: Bitte aktiviere Deinen <span style="line-height:20.8px">WorkoutCloud&nbsp;</span>Account
                        </td>
                    </tr>
                </tbody></table>                
            </td>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://workoutcloud.net/images/email/cloud_header_grey.jpg" width="564" style="max-width:700px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://workoutcloud.net/images/email/last_step.png" width="564" style="max-width:700px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="text-align: center;"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span style="color: #4D4D4D;font-size: 13px;line-height: 1.6em;">Bitte folge diesem Link, um mit nur einem Klick deinen Account zu verifizieren. Andernfalls k&ouml;nnen wir dir keine personalisierten Workout Vorschl&auml;ge zu den abwechslungsreichsten Workouts vorschlagen und du kannst keine Workouts erstellen!</span></span></h1>
<br>
&nbsp;
                        </td>
                    </tr>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #FFA200;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Account verifizieren" href="https://workoutcloud.net/view/#/confirm/<?php echo $confirmationCode; ?>" target="_blank" style="font-weight: normal;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Account verifizieren</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <td valign="top" class="mcnTextBlockInner">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px; line-height: 200%; text-align: left;">
                        
                            <em>Falls der Link nicht funktioniert, kopiere bitte den Link https://workoutcloud.net/view/#/confirm/<?php echo $confirmationCode; ?> direkt in die Adresszeile deines Browsers. Falls du Fragen hast, kontaktiere uns &uuml;ber welcome@workoutcloud.net<br>
<br>
Copyright &copy; 2016 Sidefits, All rights reserved.</em><br>
<strong>Our mailing address is:</strong><br>
Sidefits<br>
Joschka Sondhof and Philipp M&auml;gel GbR<br>
Osterbrook 22<br>
20537 Hamburg
                        </td>
                    </tr>
