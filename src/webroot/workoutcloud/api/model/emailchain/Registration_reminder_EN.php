                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="366" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                            ...
                            Reminder: Please verify your <span style="line-height:20.8px">WorkoutCloud&nbsp;</span>account
                        </td>
                    </tr>
                </tbody></table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="text-align: center;"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span style="color: #4D4D4D;font-size: 13px;line-height: 1.6em;">Please click the button below to verify your account. Otherwise you won't&nbsp;be able to receive the most versatile and personalized workout suggestions and cannot&nbsp;create workouts!</span></span></h1>
<br>
&nbsp;
                        </td>
                    </tr>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Click to verify to get personalized recommendations" href="https://workoutcloud.net/view/#/confirm/<?php echo $confirmationCode; ?>" target="_blank" style="font-weight: normal;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Click to verify to get personalized recommendations</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px; line-height: 200%; text-align: left;">
                            ...
                            <em>If the link does not work, please copy this link https://workoutcloud.net/view/#/confirm/<?php echo $confirmationCode; ?> directly into your browser. If you have any questions or problems, contact us at welcome@workoutcloud.net&nbsp;<br>
<br>
Copyright © 2016 Sidefits, All rights reserved.</em><br>
