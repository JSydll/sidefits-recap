                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="366" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                            ...
                            WorkoutCloud: Account verifizieren
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://workoutcloud.net/images/email/icon_header_grey.png" width="564" style="max-width:700px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="text-align: center;"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span style="color: #4D4D4D;font-size: 13px;line-height: 1.6em;">Bitte klicke auf den untenstehenden Button, um die Anmeldung abzuschließen. Danach wirst du personalisierte Vorschläge für die abwechslungsreichsten&nbsp;Workouts erhalten und kannst eigene Workouts erstellen!</span></span></h1>
<br />
&nbsp;
                        </td>
                    </tr>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Anmeldung abschlie&szlig;en" href="https://workoutcloud.net/view/#/confirm/<?php echo $confirmationCode; ?>" target="_blank" style="font-weight: normal;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Anmeldung abschließen</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px; line-height: 200%; text-align: left;">
                            ...
                            <em>Falls der Link nicht funktioniert, kopiere bitte den Link https://workoutcloud.net/view/#/confirm/<?php echo $confirmationCode; ?> direkt in die Adresszeile deines Browsers. Falls du Fragen hast, wende dich bitte an welcome@workoutcloud.net.<br />
<br />
